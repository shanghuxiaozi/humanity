...
//				alert('您的位置：'+r.point.lng+','+r.point.lat);
				...
				var _value = addComp.province  + addComp.city + addComp.district  + addComp.street  + addComp.street_number;
				if( typeof _this.geolocationHandler === 'function' ){
					_this.geolocationHandler(_value,r.point);
				}
			}
			else {
...
/**当未查询到路线时的抛错函数**/
Bookingmap.prototype.addEventListenGeolocation=function(handler){
	var _this = this;
	_this.geolocationHandler = handler;
}
